...
class AlayaTests: XCTestCase {

    func testAddress() {
        let key = PrivateKey(data: Data(hexString: "03a4130e4abb887a296eb38c15bbd83253ab09492a505b10a54b008b7dcc1668")!)!
        let pubkey = key.getPublicKeySecp256k1(compressed: false)
        let address = AnyAddress(publicKey: pubkey, coin: .alaya)
        let addressFromString = AnyAddress(string: "0xC115CEADF9e5923330e5f42903Fe7f926DDA65D2", coin: .alaya)!

...
package com.trustwallet.core.app.blockchains.alaya
...
class TestAlayaAddress {
    ...
    fun testAddress() {
        ...
        val address = AnyAddress(pubkey, CoinType.ALAYA)
        val expected = AnyAddress("0xC115CEADF9e5923330e5f42903Fe7f926DDA65D2", CoinType.ALAYA)
